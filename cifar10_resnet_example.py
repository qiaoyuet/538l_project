...
# CIFAR-10 dataset
train_dataset = torchvision.datasets.CIFAR10(root='/home/qiaoyuet/project/cifar10',
                                             train=True,
                                             transform=transform,
                                             download=True)

test_dataset = torchvision.datasets.CIFAR10(root='/home/qiaoyuet/project/cifar10',
                                            train=False,
...
for epoch in range(num_epochs):
    for i, (images, labels) in enumerate(train_loader):
        ...
        if (i+1) % 50 == 0:
            print ("Epoch [{}/{}], Step [{}/{}], Loss: {:.4f}, Grad norm: {:.3f}, Grad min: {:.3f}, Grad max: {:.3f}"
                   .format(epoch+1, num_epochs, i+1, total_step, loss.item(), grad_norm, grad_min, grad_max))
